...
public class BlogPost {
    ...
    @Size(min=10, max=10000, message="Content Preview field must be between 60 and 150 characters long!")
    ...
    @Size(min=8, max=30, message="Date field must be between 4 and 20 characters long!")
    private String date;
    ...
    public BlogPost() {
   	...
   	public BlogPost(int id,
   			...
   			@NotNull(message = "Content Preview field cannot be empty!") @Size(min = 10, max = 10000, message = "Content Preview field must be between 60 and 150 characters long!") String contentPreview,
   			@NotNull(message = "Blog Content field cannot be empty!") @Size(min = 100, max = 10000000, message = "Blog Content field must be between 1 and 600000 characters long!") String fullContent,
   			...
   			@NotNull(message = "Date field cannot be empty!") @Size(min = 8, max = 30, message = "Date field must be between 4 and 20 characters long!") String date,
   			int likes) {
   		super();
   		this.id = id;
   		this.title = title;
